...
class ImageToImage2D(Dataset):
    ...
    def __init__(self, dataset_path: str,dataset_name:str ,joint_transform: Callable = None, one_hot_mask: int = False) -> None:
    ...
    def __getitem__(self, idx):
        ...
        if self.dataset_name == "MoNuSeg":
            mask[mask <= 127] = 0
            mask[mask > 127] = 1
        elif self.dataset_name == "TNBC":
            mask[mask <= 127] = 0
            mask[mask > 127] = 1
        ...
        return image, mask,real_img, image_filename
